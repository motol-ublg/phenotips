...
public class R71292PhenoTips2154DataMigration extends AbstractHibernateDataMigration
{
    ...
    private class MigratePedigreeCallback implements HibernateCallback<Object>
    {
        ...
        /**
         * A new family document with processed pedigree obkect is created for a patient with an old version pedigree.
        ...
        private XWikiDocument importPedigreeToFamily(XWikiDocument patientXDocument) throws XWikiException
        {
            ...
            JSONObject procesedData =
                migrator.familyMigrations.processPedigree(JSONObject.fromObject(dataText), patientId);
